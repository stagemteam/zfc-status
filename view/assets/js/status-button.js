PopovStatusButton = {
    ...
    changeStatus: function(event) {
        ...
        PopovPreloader.load(); // @todo Attach preloader to pre ajax event
        ...
        $.ajax({
            ...
            if ($.trim(data.message).length > 0) {
                ...
                // Статус впливає на багато умов, тому не зовсім доречно оновлювати певні блоки
                // так як все рівно потрібно онвлювати сторінку в цілому
...
jQuery(document).ready(function ($) {
    PopovStatusButton.attachEvents();
    ...
    $('.ui-jqgrid-btable').bind('jqGrid.loadComplete', function() {
        PopovStatusButton.attachEvents(); // reattach print barcode button
    });
});